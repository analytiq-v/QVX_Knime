 ...
 *
 * To instantiate this table you need to specify {@link QvxFileReaderNodeSettings} and
...
public class QvxFileTable implements DataTable {
    ...
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(QvxFileTable.class);
    ...
    private final LinkedList<WeakReference<QvxFileRowIterator>> m_iterators;
    ...
    public QvxFileTable(final DataTableSpec tableSpec,
        ...
        m_iterators = new LinkedList<WeakReference<QvxFileRowIterator>>();
    ...
    public void dispose() {
        synchronized (m_iterators) {
            for (WeakReference<QvxFileRowIterator> w : m_iterators) {
        ...
        try {
            ...
            synchronized (m_iterators) {
            	QvxFileRowIterator i =
                        new QvxFileRowIterator(m_frSettings, m_tableSpec,
                                m_skipColums, m_exec);
                m_iterators.add(new WeakReference<QvxFileRowIterator>(i));
                return i;
