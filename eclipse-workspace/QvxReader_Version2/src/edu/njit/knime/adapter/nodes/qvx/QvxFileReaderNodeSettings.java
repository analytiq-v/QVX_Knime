...
public class QvxFileReaderNodeSettings extends TokenizerSettings {
    ...
    private static final NodeLogger LOGGER =
            NodeLogger.getLogger(QvxFileReaderNodeSettings.class);

    /* the list of settings that are stored in here. */

    private URL m_dataFileLocation = null;
    ...
    public void init() throws MalformedURLException {
    	...
    	m_dataFileLocation = new URL("file:/Users/bsangam/eclipse-workspace/QvxExtension/Customer.csv");
