 ...
 * @author 
 */
public class QvxPluginNodePlugin extends Plugin {
    // The shared instance.
    private static QvxPluginNodePlugin plugin;

    /**
     * The constructor.
     */
    public QvxPluginNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QvxPluginNodePlugin getDefault() {
        return plugin;
    }
