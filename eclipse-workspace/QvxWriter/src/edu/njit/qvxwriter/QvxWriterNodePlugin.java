 ...
 * @author 
 */
public class QvxWriterNodePlugin extends Plugin {
    // The shared instance.
    private static QvxWriterNodePlugin plugin;

    /**
     * The constructor.
     */
    public QvxWriterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QvxWriterNodePlugin getDefault() {
        return plugin;
    }
