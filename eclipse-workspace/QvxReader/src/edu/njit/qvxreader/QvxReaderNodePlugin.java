 ...
 * @author Monica
 */
public class QvxReaderNodePlugin extends Plugin {
    // The shared instance.
    private static QvxReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public QvxReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QvxReaderNodePlugin getDefault() {
        return plugin;
    }
